...
bc. http://localhost:2990/jira/rest/tribs-rest/1.0/contributions/all.xml?os_username=admin&os_password=admin

* This will do the same for a given period.

bc. http://localhost:2990/jira/rest/tribs-rest/1.0/contributions/period.xml?os_username=admin&os_password=admin&startDate=2010-01-01&endDate=2010-02-01
